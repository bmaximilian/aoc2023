...
describe('day2', () => {
    ...
    describe('task2', () => {
        describe('getMinCubesForLine', () => {
            it('1', () => {
                expect(getMinCubesForLine('Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green')).toEqual({
                    red: 4,
                    green: 2,
                    blue: 6,
                });
            ...
            it('2', () => {
                expect(getMinCubesForLine('Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue')).toEqual({
                    red: 1,
                    green: 3,
                    blue: 4,
                });
            ...
            it('3', () => {
                expect(
                    getMinCubesForLine('Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red'),
                ).toEqual({
                    red: 20,
                    green: 13,
                    blue: 6,
            ...
            it('4', () => {
                expect(
                    getMinCubesForLine('Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red'),
                ).toEqual({
                    red: 14,
                    green: 3,
                    blue: 15,
            ...
            it('5', () => {
                expect(getMinCubesForLine('Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green')).toEqual({
                    red: 6,
                    green: 3,
                    blue: 2,
                });
        ...
        describe('getPowerOfMinimumCubes', () => {
            ...
            it('should return the sum of the required cubes', () => {
                expect(getPowerOfMinimumCubes(input)).toBe(2286);
            });
        });
    });
});
